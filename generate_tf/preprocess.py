...
flags.DEFINE_string(
    "output_base_dir", "../data/proc_data/unsup_demo", "Data directory of the processed data")
...
flags.DEFINE_string(
    "vocab_file", "../Chinese_BERT_model/vocab.txt", "The path of the vocab file of BERT.")
...
def dump_tfrecord(features, data_path, worker_id=None, max_shard_size=4096):
  ...
  shard_size = 0
  # TODO PRINT
  print("[Log] Writing to", os.path.join( data_path, "tf_examples.tfrecord.{:d}.{:d}".format(worker_id, shard_cnt)))
