...
class IMDbProcessor(DataProcessor):
  ...
  def get_labels(self, raw_data_dir="../data/IMDB_raw/train.txt"):
    """See base class."""
    if raw_data_dir is not None:
      with tf.gfile.Open(raw_data_dir, "r") as f:
      ...
      # return ["标签1","标签2","标签3","标签4","标签5"]
      print("get labels [pos, neg]")
      return ["pos", "neg"] # TODO labels
